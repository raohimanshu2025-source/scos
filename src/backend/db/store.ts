...
export const ROLE_PERMISSIONS_MAP: Record<RoleType, PermissionType[]> = {
  ...
  [RoleType.DISTRICT_ADMIN]: [
    ...
    PermissionType.INCIDENT_VIEW,
    PermissionType.INCIDENT_CREATE,
    PermissionType.INCIDENT_UPDATE,
    PermissionType.DASHBOARD_VIEW,
    PermissionType.ANALYTICS_VIEW,
    PermissionType.AI_VIEW,
    PermissionType.AI_ANALYSIS,
    PermissionType.AI_RECOMMENDATION_REVIEW,
    PermissionType.PREDICTIVE_VIEW,
    PermissionType.PREDICTIVE_APPROVE,
    PermissionType.GRAPH_VIEW,
    PermissionType.GRAPH_MODIFY,
    PermissionType.GRAPH_IMPORT,
    PermissionType.SCENARIO_EXECUTE,
    PermissionType.DATA_SOURCE_VIEW,
    PermissionType.DATA_SOURCE_CREATE,
    PermissionType.DATA_SOURCE_UPDATE,
    PermissionType.DATA_SOURCE_ADMIN,
    PermissionType.DATA_VALIDATION_VIEW,
    PermissionType.DATA_VALIDATION_EXECUTE,
    PermissionType.DATA_QUALITY_VIEW,
    PermissionType.DATA_QUALITY_ADMIN,
    PermissionType.INFRASTRUCTURE_VIEW,
    PermissionType.INFRASTRUCTURE_CREATE,
    PermissionType.INFRASTRUCTURE_UPDATE,
    PermissionType.SPATIAL_ANALYSIS_VIEW,
    PermissionType.SPATIAL_ANALYSIS_EXECUTE,
    PermissionType.COORDINATION_VIEW,
    PermissionType.COORDINATION_RECOMMEND,
    PermissionType.COORDINATION_APPROVE,
    PermissionType.COORDINATION_EXECUTE,
    PermissionType.COORDINATION_ADMIN,
    PermissionType.OPERATIONAL_MONITORING_VIEW,
    PermissionType.SITUATIONAL_AWARENESS_VIEW,
    PermissionType.OPERATIONAL_DECISION_SUPPORT_VIEW,
    PermissionType.OPERATIONAL_DECISION_SUPPORT_REVIEW,
    PermissionType.URBAN_DIGITAL_TWIN_VIEW,
    PermissionType.SCENARIO_VALIDATION_VIEW,
    PermissionType.SCENARIO_VALIDATION_EXECUTE,
    PermissionType.COMPARATIVE_EVALUATION_VIEW,
    PermissionType.COMPARATIVE_EVALUATION_EXECUTE,
    PermissionType.RESEARCH_DATASET_VIEW,
    PermissionType.RESEARCH_DATASET_ADMIN,
    PermissionType.RESEARCH_DATASET_EXECUTE,
    PermissionType.EXPERIMENTAL_EXECUTION_VIEW,
    PermissionType.EXPERIMENTAL_EXECUTION_EXECUTE,
    PermissionType.EXPERIMENTAL_EXECUTION_ADMIN,
    PermissionType.STATISTICAL_ANALYSIS_VIEW,
    PermissionType.STATISTICAL_ANALYSIS_EXECUTE,
    PermissionType.STATISTICAL_ANALYSIS_ADMIN,
    PermissionType.RESEARCH_EVIDENCE_VIEW,
    PermissionType.RESEARCH_EVIDENCE_ADMIN,
    PermissionType.RESEARCH_EVIDENCE_EXPORT,
    PermissionType.RESEARCH_FRAMEWORK_VIEW,
    PermissionType.RESEARCH_FRAMEWORK_ADMIN,
    PermissionType.RESEARCH_FRAMEWORK_EXPORT,
    PermissionType.SENSITIVITY_ANALYSIS_VIEW,
    PermissionType.SENSITIVITY_ANALYSIS_EXECUTE,
    PermissionType.SENSITIVITY_ANALYSIS_ADMIN,
    PermissionType.RESEARCH_VALIDATION_VIEW,
    PermissionType.RESEARCH_VALIDATION_ADMIN,
    PermissionType.RESEARCH_CLAIMS_VIEW,
    PermissionType.RESEARCH_CLAIMS_VALIDATE,
    PermissionType.THESIS_EVIDENCE_VIEW,
    PermissionType.THESIS_EVIDENCE_EXPORT,
    PermissionType.RESEARCH_DEMONSTRATION_VIEW,
    PermissionType.RESEARCH_DEMONSTRATION_ADMIN,
  ],
...
// =========================================================================
// DEMO & DEVELOPMENT SEEDED USERS
// NOTE: These are synthetic demonstration accounts intended for prototype
// evaluation and thesis demonstration in non-production environments.
// Default passwords must NEVER be presented as production credentials.
// =========================================================================
